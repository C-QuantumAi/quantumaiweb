    ...
    return (React.createElement("div", { className: "dl-page" },
        React.createElement("div", { className: "dl-hero" },
            ...
            React.createElement("h1", { className: "dl-title" },
                ...
                "on Your Own Device"),
            React.createElement("p", { className: "dl-sub" }, "Strong AES-256 encryption, a private personal-cloud backup, and a local AI assistant \u2014 as a standalone desktop app for Windows & Mac. Your files, keys, and data stay on your machine."),
            React.createElement("div", { className: "dl-platforms" }, ["🪟 Windows 10/11", "🍎 macOS 12+", "🔒 AES-256", "🤖 Local AI", "☁️ Personal Cloud"].map((p, i) => (React.createElement("div", { key: i, className: "platform-chip" }, p)))),
            React.createElement("div", { style: { marginTop: "2.5rem", maxWidth: 880, marginLeft: "auto", marginRight: "auto" } },
                React.createElement("img", { src: "/vault-preview.png", alt: "QuantumAI Vault app preview \u2014 the interface you'll get after installing", style: { width: "100%", height: "auto", borderRadius: 14, border: "1px solid rgba(255,255,255,0.1)", boxShadow: "0 40px 100px rgba(0,0,0,0.5)" } }),
                React.createElement("p", { style: { fontSize: ".72rem", color: "rgba(180,210,255,0.45)", marginTop: ".8rem", textAlign: "center" } }, "A preview of the QuantumAI Vault interface."))),
                ...
                React.createElement("div", { className: "dl-card-header" },
                    ...
                    React.createElement("div", null,
                        ...
                        React.createElement("div", { className: "dl-card-sub" },
                            ...
                            " \u00B7 ",
                            app.arch))),
                React.createElement("p", { style: { fontSize: ".82rem", color: "rgba(180,210,255,0.7)", lineHeight: 1.55, margin: "0 0 1rem", padding: "0 .2rem" } },
                    "Encrypt and back up your files, and run a private AI assistant \u2014 all locally on your ",
                    app.os === "macOS" ? "Mac" : "PC",
                    ". Your files, keys, and data never leave your device."),
    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement("nav", { className: "nav" },
            ...
            React.createElement("div", { className: "nav-links" },
                ...
                React.createElement("button", { className: "nav-pill", onClick: () => window.open("https://github.com/C-QuantumAi/QuantumAI/blob/main/QuantumAI-Whitepaper-v2.pdf", "_blank", "noopener,noreferrer") }, "Whitepaper"),
            ...
            mobileMenu && (React.createElement("div", { className: "mobile-menu" }, [
                ...
                { label: "Whitepaper", act: () => window.open("https://github.com/C-QuantumAi/QuantumAI/blob/main/QuantumAI-Whitepaper-v2.pdf", "_blank", "noopener,noreferrer") },
        ...
        page === "home" && (React.createElement("section", { id: "home", className: "hero" },
            ...
            React.createElement("h1", { className: "hero-title" },
                React.createElement("span", { className: "line1" }, "QuantumAI"),
                React.createElement("span", { className: "line2" }, "Your multi-purpose AI agent")),
            React.createElement("p", { className: "hero-sub" }, "A multi-purpose AI agent system built to encrypt and decrypt, back up the files and folders that matter to you, and let you create your very own secure private cloud storage \u2014 with AES-256 encryption and post-quantum-secured cloud sync."),
